...
function [avgDistMean, avgAngMean, stddevDistMean, stddevAngMean, avgDistMax, avgAngMax, stddevDistMax, stddevAngMax, D] = pf_SIM_2_1(simFile, makePlot, gsd_, wbd, psf_, np_, rsm_)
